...
Julius Schramm <julius.schramm@stud.htw-dresden.de>; Vorname2 Nachname2 <email2@domain.org>; Vorname3 Nachname3 <email3@domain.org>
{localdatetime}
...
| Sebastian Treß | Architekt, Programmierer | s86372@htw-dresden.de | Informatik
| Niklas Große | Archtitekt, Programmierer | s86379@htw-dresden.de | Informatik
