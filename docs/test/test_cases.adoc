...
| TC-01 | Hin- und Rückspiel für jede Paarung in der Leistungsgruppe | erledigt/bestanden
| TC-02 | Kein Team pfeift zweimal direkt hintereinander | noch offen
| TC-03 | Keine Folge: pfeifen – aussetzen – pfeifen | noch offen
| TC-04 | Kein Team setzt länger als ein Spiel aus | noch offen
| TC-05 | - | –
|===
...
*Bemerkung:* Manueller Test generiert aus dem Turnierplangenerator mit den Eingabewerten von oben.
