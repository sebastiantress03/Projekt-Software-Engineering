...
class Test8M2L3F_HR(Testmygenerator):
    """
    Testklasse für den konkreten Turnierfall: 8 Teams, 3 Felder, 2 Gruppen, Hin- und Rückspiel aktiviert.
