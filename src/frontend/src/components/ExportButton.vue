<template>
    <div class="export-container">
        <HomeButton color="primary" @click="openExportDialog"
            >Exportieren</HomeButton
        >
        ...
        <div v-if="showExportDialog" class="export-dialog">
            <div class="dialog-content">
                ...
                <div v-else-if="loadingMatches" class="loading-message">
                    Lade Spielpläne...
                </div>
                ...
                <div v-else class="form-group">
                    ...
                    <div
                        v-if="selectedTournament?.matches"
                        class="matches-info"
                    >
                        <p>
                            {{ selectedTournament.matches.length }} Spiele
                            verfügbar
                        </p>
                    </div>
                </div>
                ...
                <div class="button-group">
                    <HomeButton color="secondary" @click="closeExportDialog"
                    ...
                    <HomeButton
                        ...
                        @click="exportToCSV"
                        :disabled="
                            !selectedTournament || !selectedTournament.matches
                        "
                    >
                        <span v-if="exporting">
    ...
    methods: {
        ...
        async fetchTournaments() {
            ...
            try {
                ...
                this.error =
                    "Turniere konnten nicht geladen werden: " + error.message;
            } finally {
                this.loading = false;
            }
        },
        ...
        async onTournamentSelect() {
            if (this.selectedTournament && !this.selectedTournament.matches) {
                ...
                try {
                    ...
                    this.selectedTournament.matches = Array.isArray(
        ...
        async exportToCSV() {
            ...
            try {
                ...
                const rows = this.selectedTournament.matches.map((match) => {
                    const teamA =
                        match.team_names?.[0] || match.teamA || "Unbekannt";
                    const teamB =
                        match.team_names?.[1] || match.teamB || "Unbekannt";
                ...
                link.href = url;
                link.download = `turnier_${this.selectedTournament.name.replace(
                    /[^a-z0-9]/gi,
                    "_"
