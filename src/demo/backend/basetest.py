...
def create_html(schedule, fields):
    """
    Erzeugt eine HTML-Tabelle zur Darstellung des Turnierplans mit Zeit, Spielfeldern und Schiedsrichtern.

    Parameter:
        - schedule (list): Der finale Spielplan.
        - fields (int): Anzahl der verfügbaren Spielfelder.

    Rückgabewert:
        - str: HTML-Code als String.

    Fehlerbehandlung:
        - Keine direkte Fehlerbehandlung.

    Hinweise:
        - Spielplan wird nach Uhrzeit gruppiert dargestellt.
        - „Einspielzeit“ und „Pause“ erscheinen auf allen Feldern.
        - Jeder Eintrag enthält Teamnamen, Matchtyp und Schiedsrichter.
    """
    html = """
    <!DOCTYPE html>
    <html lang="en">
