...
class DatabaseRequests:
    ...
    def get_tournament_id(self, name: str):
        try:
    ...
    def insert_tournament_data(self, tournament_id: int, team1: str, team2: str, referee: str, field: int, stage_name: str, play_time: time):
        try:
    ...
    def get_tournament_plan(self, tournament_id: int):
        return_date = []
        try:
            data = server.query("""SELECT DISTINCT e.SpielID, e.SpielfeldNr, t1.Teamname, t2.Teamname, t3.Teamname,l.Leistungsgruppenname, e.Spielergebnis1, e.Spielergebnis2, e.Uhrzeit FROM Ergebnisse e 
    ...
    def change_results(self, match_id: int, score1: int, score2: int, time_change: time):
        try:
