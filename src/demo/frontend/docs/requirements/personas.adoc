...
Julius Schramm <julius.schramm@stud.htw-dresden.de> ; Oliver Theumer <oliver.theumner@stud.htw-dresden.de> ; Louai Alrefai <loaui.alrefai@stud.htw-dresden.de>
{localdatetime}
...
image:Ingeborg_Regina.png[width=300, height=300]
...
image:Ingeborg_Regina_Verhaltensweisen.png[width=300, height=300]

== Julia Ludolf

image:Julia_Ludolf.jpg[width=300, height=300]
...
image:Julia_Ludolf_Verhaltensweisen.png[width=300, height=300]