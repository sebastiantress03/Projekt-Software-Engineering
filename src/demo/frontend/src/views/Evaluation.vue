<template>
    <div class="container">
      ...
      <header>
        <div class="logo-container">
          <img
            src="https://cdn.discordapp.com/attachments/1298906917204131942/1318175404661411891/STURA_HTWD_Logo.png?ex=68023502&is=6800e382&hm=86396ed9ab73fc3da622150fc382aaaa1a5e3efe5113ee4b65742ab563cfc57e&"
            alt="STURA HTWD Logo"
            class="logo"
          />
        </div>
  ...
  const dummyData = {
    gruppe1: {
      ...
      results: [
        { platz: 1, team: 'Team Alpha', s: 10, n: 1, p: 130, g: 90, diff: 40 },
        { platz: 2, team: 'Team Beta', s: 8, n: 3, p: 110, g: 95, diff: 15 }
      ]
    },
    gruppe2: {
      winners: ['Team Delta'],
      results: [
        { platz: 1, team: 'Team Delta', s: 9, n: 2, p: 120, g: 80, diff: 40 },
        { platz: 2, team: 'Team Omega', s: 7, n: 4, p: 100, g: 88, diff: 12 }
      ]
    }
  };
